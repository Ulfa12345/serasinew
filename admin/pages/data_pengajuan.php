...
// Menampilkan disposisi ke
$sql = "
SELECT d.*, a.nama AS nama_admin
FROM tb_dokumen d
LEFT JOIN tb_admin a ON d.id_admin = a.id_admin
ORDER BY d.id_dok DESC
";
$data = $conn->query($sql);
                                        ...
                                        <?php if (isset($admin['role']) && $admin['role'] === 'supervisor'): ?>
                                            ...
                                            <?php if ($row['id_admin'] == null): ?>
                                                ...
                                                <button class="btn btn-info"
                                                    ...
                                                    data-id="<?= $row['id_dok'] ?>">
                                                    <i class="fa fa-paper-plane" aria-hidden="true"></i> Disposisi
                                                </button>
                                            <?php else: ?>
                                                <!-- SUDAH DIDISPOSISI -->
                                                <span class="badge badge-success">
                                                    <i class="fa fa-check"></i>
                                                    Sudah Didisposisi ke : <?= $row['nama_admin'] ?? '-' ?>
                                                </span>
                                            <?php endif; ?>
