...
<div class="navbar navbar-fixed-top">
  <div class="navbar-inner">
    <div class="container"> <a class="btn btn-navbar" data-toggle="collapse" data-target=".nav-collapse"><span
                    class="icon-bar"></span><span class="icon-bar"></span><span class="icon-bar"></span> </a><a class="brand" href="index.html">SERASI BBPOM di Surabaya</a>
      <div class="nav-collapse">
        <ul class="nav pull-right">
          ...
          <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown"><i
                            class="icon-user"></i> <?php echo $det['nama_detail'] ?> <b class="caret"></b></a>
            <ul class="dropdown-menu">
    ...
    <div class="container">
      <ul class="mainnav">
        ...
        <li class="dropdown"><a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown"> <i class="icon-user"></i><span>Profil</span> <b class="caret"></b></a>
          <ul class="dropdown-menu">
            <li><a href="./index.php?page=profil">Data Pengguna</a></li>
          </ul>
        </li>
        <li class="dropdown"><a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown"> <i class="icon-briefcase"></i><span>Komoditi</span> <b class="caret"></b></a>
          <ul class="dropdown-menu">
            <?php
              include "../conf/conn.php";
            ...
            ?>
            <li><a href="./index.php?page=<?php echo $currentkom['id_komoditi']; ?>"><?php echo $currentkom['nama_komoditi'] ?></a></li>
          <?php } ?>
          </ul>
        </li>
      </ul>
  ...
  <div class="extra-inner">
    <div class="container">
      <div class="row">
                    <div class="span3">
                        <h4>
                            Tentang SERASI BBPOM di Surabaya</h4>
                        <ul>
                            <li><a href="javascript:;">Tentang Kami</a></li>
                            <li><a href="javascript:;">Tutorial</a></li>
                            <li><a href="javascript:;">Tracking System</a></li>
                            <li><a href="javascript:;">Dashboard BBPOM di Surabaya</a></li>
                        </ul>
                    </div>
                    <!-- /span3 -->
                    <div class="span3">
                        <h4>
                            Pilihan Komoditi</h4>
                        <ul>
                            <li><a href="javascript:;">Pangan/BTP</a></li>
                            <li><a href="javascript:;">Kosmetik</a></li>
                            <li><a href="javascript:;">Obat Tradisional</a></li>
                            <li><a href="javascript:;">Obat</a></li>
                            <li><a href="javascript:;">Suplemen Kesehatan</a></li>
                        </ul>
                    </div>
                    <!-- /span3 -->
                    <div class="span3">
...
<div class="footer">
  <div class="footer-inner">
    <div class="container">
      <div class="row">
        <div class="span12"> &copy; <?php echo date('Y'); ?> <a href="#">Balai Besar Pengawas Obat dan Makanan di Surabaya</a>. </div>
        <!-- /span12 --> 
      </div>
      <!-- /row --> 
    </div>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <a class="btn btn-primary" style="background-color: #19bc9c;" href="pages/auth/logout_process.php">Logout</a>
        </div>
      </div>
    </div>
  </div>