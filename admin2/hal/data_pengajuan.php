            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    while ($row = $result->fetch_assoc()): 
                        ...
                        $server_path_sipa = $_SERVER['DOCUMENT_ROOT'] . '/serasinew/admin/pages/dokumen/uploads/' . basename($row['upload_sipa']);
                        $web_path_sipa = '/serasinew/admin/pages/dokumen/uploads/' . basename($row['upload_sipa']);

                        $server_path_sph = $_SERVER['DOCUMENT_ROOT'] . '/serasinew/admin/pages/dokumen/uploads/' . basename($row['upload_suratpermohonan']);
                        $web_path_sph = '/serasinew/admin/pages/dokumen/uploads/' . basename($row['upload_suratpermohonan']);

                        $server_path_spn = $_SERVER['DOCUMENT_ROOT'] . '/serasinew/admin/pages/dokumen/uploads/' . basename($row['upload_suratpernyataan']);
                        $web_path_spn = '/serasinew/admin/pages/dokumen/uploads/' . basename($row['upload_suratpernyataan']);

                        $server_path_pbf = $_SERVER['DOCUMENT_ROOT'] . '/serasinew/admin/pages/dokumen/uploads/' . basename($row['upload_ijin_pbf']);
                        $web_path_pbf = '/serasinew/admin/pages/dokumen/uploads/' . basename($row['upload_ijin_pbf']);

                        $server_path_dnhlma = $_SERVER['DOCUMENT_ROOT'] . '/serasinew/admin/pages/dokumen/uploads/' . basename($row['upload_denahlama']);
                        $web_path_dnhlma = '/serasinew/admin/pages/dokumen/uploads/' . basename($row['upload_denahlama']);

                        $server_path_dnhbru = $_SERVER['DOCUMENT_ROOT'] . '/serasinew/admin/pages/dokumen/uploads/' . basename($row['upload_denahbaru']);
                        $web_path_dnhbru = '/serasinew/admin/pages/dokumen/uploads/' . basename($row['upload_denahbaru']);
